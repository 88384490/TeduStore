...
public class User implements Serializable {
    /**
     * 序列化ID:-7537649480332127159L
     */
    private static final long serialVersionUID = -7537649480332127159L;
    private Integer id;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((personImage == null) ? 0
                : personImage.hashCode());
        result = prime * result
    ...
    public boolean equals(Object obj) {
        ...
        if (password == null) {
            ...
            return false;
        if (personImage == null) {
            if (other.personImage != null)
                return false;
        } else if (!personImage.equals(other.personImage))
            return false;
        if (phone == null) {
            if (other.phone != null)
                return false;
    ...
    public String toString() {
        return "User [id=" + id + ", username=" + username
                ...
                + ", phone=" + phone + ", personImage=" + personImage
                + ", gender=" + gender + ", createdUser="
