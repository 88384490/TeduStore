<%@ page contentType="text/html;charset=UTF-8" language="java"%>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head lang="en">
            ...
            <link href="../css/icon/css/font-awesome.min.css" rel="stylesheet">
        </head>
                            ...
                            <div class="rs_content">
                                ...
                                <form id="person-form" action="">
                                    ...
                                    <div class="rs_content_sex">
                                        ...
                                        <input type="radio" name="gender" id="gender1" value="1" <c:if test="${user.gender==1}"> checked
                                        </c:if>
                                        />男
                                        <input type="radio" name="gender" id="gender0" value="0" <c:if test="${user.gender==0}"> checked
                                        </c:if>
                                        />女
                                    </div>
                                    <!--绑定电话-->
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="avatar-preview preview-sm"></div>-->
                                        ...
                                        <div class="row avatar-btns">
                                            <div class="col-md-4">
                                                <div class="btn-group">
                                                    <button class="btn btn-info fa fa-undo" data-method="rotate" data-option="-90" type="button" title="Rotate -90 degrees">
                                                    向左旋转</button>
                                                </div>
                                                <div class="btn-group">
                                                    <button class="btn  btn-info fa fa-repeat" data-method="rotate" data-option="90" type="button" title="Rotate 90 degrees">
                                                    向右旋转</button>
                                                </div>
                                            </div>
        ...
        <script type="text/javascript">
            function getImage() {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    //异步上传数据需要加一下两个参数
                    //contentType表示设置内容类型、processData表示不去处理上传文件的数据
                    contentType: fales,
                    processData: fales,
