...
$.ajax({
	...
	success : function (obj) {
		alert(obj.message);
		//1. 把六个文本框清空
		$("#receiverName").val("");//将收货人名字清空
		$("#receiverAddress").val("");//将收货人地址清空
		$("#receiverMobile").val("");//将收货人手机清空
		$("#receiverPhone").val("");//将收货人号码清空
		$("#receiverZip").val("");//将邮政编码清空
		$("#addressName").val("");//将地址名称清空
		//2. 将3个下拉列表还原为初始状态
