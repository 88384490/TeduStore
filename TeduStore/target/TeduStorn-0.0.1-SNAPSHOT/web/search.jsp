    ...
    <form name="" action="" method="post">
        <section id="section">
            ...
            <div id="wrap">
                    ...
                    <div class="info">
                        ...
                        <div class="describe">
                            ...
                            <span class="price"><b>￥</b><span
                                    class="priceContent">4399.00</span></span>
                            <span class="addCart"><img id="collect" src="../images/search/care.png"
                                                       alt=""/><a href="javascript:void(0);"
                                                                  class="add_cart">加入购物车</a></span>
                ...
                <div class="lf" id="d1">
                    <div class="img">
                        <img src="../images/search/product_img1.png" alt=""
                             onclick="toItemInfo(${item.id})"/>
                    </div>
                    <div class="describe">
                ...
                <div class="lf" id="d1">
                    <div class="img">
                        <img src="../images/search/product_img2.png" alt=""
                             onclick="toItemInfo(${item.id})"/>
                    </div>
                    <div class="describe">
                        <p onclick="toItemInfo(${item.id})">联想(Lenovo) YOGA900 (YOGA4 PRO)多彩版</p>
                ...
                <div class="lf" id="d1">
                    <div class="img">
                        <img src="../images/search/product_img3.png" alt=""
                             onclick="toItemInfo(${item.id})"/>
                    </div>
                    <div class="describe">
                        <p onclick="toItemInfo(${item.id})">联想(Lenovo) YOGA900 (YOGA4 PRO)多彩版</p>
                ...
                <div class="lf" id="d1">
                    <div class="img">
                        <img src="../images/search/product_img4.png" alt=""
                             onclick="toItemInfo(${item.id})"/>
                    </div>
                    <div class="describe">
                        <p onclick="toItemInfo(${item.id})">联想(Lenovo) YOGA900 (YOGA4 PRO)多彩版</p>
                ...
                <div class="lf" id="d1">
                    <div class="img">
                        <img src="../images/search/product_img5.png" alt=""
                             onclick="toItemInfo(${item.id})"/>
                    </div>
                    <div class="describe">
                        <p onclick="toItemInfo(${item.id})">联想(Lenovo) YOGA900 (YOGA4 PRO)多彩版</p>
                ...
                <div class="lf" id="d1">
                    <div class="img">
                        <img src="../images/search/product_img6.png" alt=""
                             onclick="toItemInfo(${item.id})"/>
                    </div>
                    <div class="describe">
                        <p onclick="toItemInfo(${item.id})">联想(Lenovo) YOGA900 (YOGA4 PRO)多彩版</p>
